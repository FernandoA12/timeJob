...
function createTrayIcon() {
  window.webContents.executeJavaScript('makeImage()', false, (dataURL) => {
...
function registerShortcuts() {
  globalShortcut.register("CTRL+Y", () => timer.toggle());
  globalShortcut.register("CTRL+Shift+Y", () => timer.start(20));
}
